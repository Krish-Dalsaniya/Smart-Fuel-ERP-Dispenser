...
const icons = {
  ...
  shift: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5"><path d="M12 8v4l3 3"/><circle cx="12" cy="12" r="9"/></svg>,
  invoice: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>,
...
const navItems = [
  ...
  { to: '/shift-reports', label: 'Shift Reports', icon: icons.shift, roles: ['admin', 'operator'] },
  { to: '/invoices', label: 'Invoices', icon: icons.invoice, roles: ['admin', 'operator', 'vehicle_owner'] },
  { to: '/settings', label: 'Settings', icon: icons.settings, roles: ['admin'] },
